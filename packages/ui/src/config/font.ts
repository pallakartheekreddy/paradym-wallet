...
export const fontRubik = createFont({
  family: 'Rubik',
  weight: {
    light: '300',
    0: '300',
  ...
  face: {
    // Android uses filename, iOS uses PostScript name (configured in app.config.js with expo-font plugin)
    '300': { normal: Platform.select({ ios: 'Rubik-Light', android: 'Rubik_300Light' }) },
    '400': { normal: Platform.select({ ios: 'Rubik-Regular', android: 'Rubik_400Regular' }) },
    '500': { normal: Platform.select({ ios: 'Rubik-Medium', android: 'Rubik_500Medium' }) },
    '600': { normal: Platform.select({ ios: 'Rubik-SemiBold', android: 'Rubik_600SemiBold' }) },
    '700': { normal: Platform.select({ ios: 'Rubik-Bold', android: 'Rubik_700Bold' }) },
  },
})
